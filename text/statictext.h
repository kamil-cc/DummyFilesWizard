...
public:
    ...
    static const QString WRONG_CONFIG_FILE_MSG;

    static const QString PL_LANG;
    static const QString EN_LANG;

    static const QString FILES_LOCATION_KEY;
    static const QString LANG_KEY;
    static const QString CONFIG_LOCATION_KEY;
    static const QString TEXT_LOCATION_KEY;
    static const QString LOG_LOCATION_KEY;
